<div class="mt-2">
    ...
    <div>
        ...
        <div class="form-check {if isset($inline) && $inline} form-check-inline{/if}">
            ...
            <input type="checkbox" class="form-check-input" id="{$id}_{:md5($_key)}" name="{$name}[]" value="{$_key}" checked>
            {else}
            <input type="checkbox" class="form-check-input" id="{$id}_{:md5($_key)}" name="{$name}[]" value="{$_key}">
            {/if}
